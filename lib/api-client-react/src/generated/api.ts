 ...
 */
export const deleteCustomer = async (id: number, options?: RequestInit): Promise<OkResponse> => {
 ...
 */
export const getCustomerPricing = async (id: number, options?: RequestInit): Promise<CustomerProductPrice[]> => {
...
export const getGetCustomerPricingQueryOptions = <TData = Awaited<ReturnType<typeof getCustomerPricing>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCustomerPricing>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCustomerPricingQueryKey(id);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCustomerPricing>>> = ({ signal }) => getCustomerPricing(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCustomerPricing>>, TError, TData> & { queryKey: QueryKey }
}

export type GetCustomerPricingQueryResult = NonNullable<Awaited<ReturnType<typeof getCustomerPricing>>>
...
export function useGetCustomerPricing<TData = Awaited<ReturnType<typeof getCustomerPricing>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCustomerPricing>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const setCustomerPricing = async (id: number,
    setPricingBody: SetPricingBody, options?: RequestInit): Promise<OkResponse> => {
...
export const getSetCustomerPricingMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setCustomerPricing>>, TError,{id: number;data: BodyType<SetPricingBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof setCustomerPricing>>, TError,{id: number;data: BodyType<SetPricingBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setCustomerPricing>>, {id: number;data: BodyType<SetPricingBody>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SetCustomerPricingMutationResult = NonNullable<Awaited<ReturnType<typeof setCustomerPricing>>>
 ...
 * @summary Set custom price for a single product (admin)
 */
export const useSetCustomerPricing = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setCustomerPricing>>, TError,{id: number;data: BodyType<SetPricingBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const deleteOrder = async (id: number, options?: RequestInit): Promise<OkResponse> => {
 ...
 */
export const createInquiry = async (createInquiryBody: CreateInquiryBody, options?: RequestInit): Promise<Inquiry> => {
...
export const getCreateInquiryMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createInquiry>>, TError,{data: BodyType<CreateInquiryBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createInquiry>>, TError,{data: BodyType<CreateInquiryBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createInquiry>>, {data: BodyType<CreateInquiryBody>}> = (props) => {
          const {data} = props ?? {};
 ...
 */
export const deleteInquiry = async (id: number, options?: RequestInit): Promise<OkResponse> => {
 ...
 */
export const recordOrderPayment = async (id: number,
    recordPaymentBody: RecordPaymentBody, options?: RequestInit): Promise<OrderSummary> => {
...
export const getRecordOrderPaymentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordOrderPayment>>, TError,{id: number;data: BodyType<RecordPaymentBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof recordOrderPayment>>, TError,{id: number;data: BodyType<RecordPaymentBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof recordOrderPayment>>, {id: number;data: BodyType<RecordPaymentBody>}> = (props) => {
          const {id,data} = props ?? {};
 ...
 */
export const convertOrderGst = async (id: number, options?: RequestInit): Promise<ConvertGstResponse> => {
...
export const getConvertOrderGstMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof convertOrderGst>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof convertOrderGst>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof convertOrderGst>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ConvertOrderGstMutationResult = NonNullable<Awaited<ReturnType<typeof convertOrderGst>>>
 ...
 * @summary Convert order to GST bill (admin)
 */
export const useConvertOrderGst = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof convertOrderGst>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const deleteSupplier = async (id: number, options?: RequestInit): Promise<OkResponse> => {
...
export const getListSupplierEntriesUrl = (id: number,
  ...
  return stringifiedParams.length > 0 ? `/api/stock/suppliers/${id}/entries?${stringifiedParams}` : `/api/stock/suppliers/${id}/entries`
}

/**
 * @summary List stock entries for a supplier (admin)
 */
export const listSupplierEntries = async (id: number,
    params?: ListSupplierEntriesParams, options?: RequestInit): Promise<StockEntry[]> => {
...
export const getListSupplierEntriesQueryKey = (id: number,
    params?: ListSupplierEntriesParams,) => {
    return [
    `/api/stock/suppliers/${id}/entries`, ...(params ? [params] : [])
    ] as const;
    }


export const getListSupplierEntriesQueryOptions = <TData = Awaited<ReturnType<typeof listSupplierEntries>>, TError = ErrorType<unknown>>(id: number,
    params?: ListSupplierEntriesParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listSupplierEntries>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListSupplierEntriesQueryKey(id,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listSupplierEntries>>> = ({ signal }) => listSupplierEntries(id,params, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listSupplierEntries>>, TError, TData> & { queryKey: QueryKey }
}

export type ListSupplierEntriesQueryResult = NonNullable<Awaited<ReturnType<typeof listSupplierEntries>>>
...
export function useListSupplierEntries<TData = Awaited<ReturnType<typeof listSupplierEntries>>, TError = ErrorType<unknown>>(
 id: number,
    params?: ListSupplierEntriesParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listSupplierEntries>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const listStockEntries = async ( options?: RequestInit): Promise<StockEntry[]> => {
...
export const getListStockEntriesQueryOptions = <TData = Awaited<ReturnType<typeof listStockEntries>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listStockEntries>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListStockEntriesQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listStockEntries>>> = ({ signal }) => listStockEntries({ signal, ...requestOptions });
...
export function useListStockEntries<TData = Awaited<ReturnType<typeof listStockEntries>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listStockEntries>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const createStockEntry = async (createStockEntryBody: CreateStockEntryBody, options?: RequestInit): Promise<StockEntry> => {
...
export const getCreateStockEntryMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createStockEntry>>, TError,{data: BodyType<CreateStockEntryBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createStockEntry>>, TError,{data: BodyType<CreateStockEntryBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createStockEntry>>, {data: BodyType<CreateStockEntryBody>}> = (props) => {
          const {data} = props ?? {};
 ...
 * @summary Add a stock/purchase entry (admin)
 */
export const useCreateStockEntry = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createStockEntry>>, TError,{data: BodyType<CreateStockEntryBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const updateStockEntry = async (id: number,
    updateStockEntryBody: UpdateStockEntryBody, options?: RequestInit): Promise<StockEntry> => {
...
export const getUpdateStockEntryMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateStockEntry>>, TError,{id: number;data: BodyType<UpdateStockEntryBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateStockEntry>>, TError,{id: number;data: BodyType<UpdateStockEntryBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateStockEntry>>, {id: number;data: BodyType<UpdateStockEntryBody>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateStockEntryMutationResult = NonNullable<Awaited<ReturnType<typeof updateStockEntry>>>
 ...
 * @summary Update a stock entry (admin)
 */
export const useUpdateStockEntry = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateStockEntry>>, TError,{id: number;data: BodyType<UpdateStockEntryBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const deleteStockEntry = async (id: number, options?: RequestInit): Promise<OkResponse> => {
...
export const getDeleteStockEntryMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteStockEntry>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteStockEntry>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteStockEntry>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteStockEntryMutationResult = NonNullable<Awaited<ReturnType<typeof deleteStockEntry>>>
 ...
 * @summary Delete a stock entry (admin)
 */
export const useDeleteStockEntry = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteStockEntry>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const recordStockPayment = async (id: number,
    recordSupplierPaymentBody: RecordSupplierPaymentBody, options?: RequestInit): Promise<StockEntry> => {
...
export const getRecordStockPaymentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordStockPayment>>, TError,{id: number;data: BodyType<RecordSupplierPaymentBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof recordStockPayment>>, TError,{id: number;data: BodyType<RecordSupplierPaymentBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof recordStockPayment>>, {id: number;data: BodyType<RecordSupplierPaymentBody>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RecordStockPaymentMutationResult = NonNullable<Awaited<ReturnType<typeof recordStockPayment>>>
    export type RecordStockPaymentMutationBody = BodyType<RecordSupplierPaymentBody>
    export type RecordStockPaymentMutationError = ErrorType<unknown>

    /**
 * @summary Record a supplier payment for a stock entry (admin)
 */
export const useRecordStockPayment = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordStockPayment>>, TError,{id: number;data: BodyType<RecordSupplierPaymentBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<

...
export const GetCustomerPricingResponse = zod.array(GetCustomerPricingResponseItem)
...
export const ListSupplierEntriesResponse = zod.array(ListSupplierEntriesResponseItem)
...
export const RecordStockPaymentBody = zod.object({
  "amountPaidToSupplier": zod.number().min(recordStockPaymentBodyAmountPaidToSupplierMin)
})
